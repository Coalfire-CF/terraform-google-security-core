...
resource "google_kms_crypto_key_iam_member" "ce_account" {
  ...
  role          = "roles/cloudkms.cryptoKeyEncrypterDecrypter"
  member        = "serviceAccount:service-${google_project.management.number}@compute-system.iam.gserviceaccount.com"
...
resource "google_kms_crypto_key_iam_member" "sm_account" {
  ...
  role          = "roles/cloudkms.cryptoKeyEncrypterDecrypter"
  member        = "serviceAccount:service-${google_project.management.number}@gcp-sa-secretmanager.iam.gserviceaccount.com"
