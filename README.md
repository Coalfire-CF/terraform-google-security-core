...
| <a name="input_management_project"></a> [management\_project](#input\_management\_project) | Boolean value to determine if project should be created. | `bool` | `true` | no |
...
| <a name="input_networking_project"></a> [networking\_project](#input\_networking\_project) | Boolean value to determine if project should be created. | `bool` | `true` | no |
